...
public class GlobalConstants {
	...
	public static final String UPLOAD_FOLDER_PATH = PROJECT_PATH + "\\uploadFiles";
	public static final String DOWNLOAD_FOLDER_PATH = PROJECT_PATH + "\\downloadFiles";
	
	public static final String DEV_APP_URL = "https://www.jqueryscript.net/demo/CRUD-Data-Grid-Plugin-jQuery-Quickgrid/";
	...
	public static final String DEV_DB_PASSWORD = "";
